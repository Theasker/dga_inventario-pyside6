...
class InventarioControlador:
    ...
    def actualizar_tabla(self):
        # Bloqueamos disparos de eventos mientras refrescamos
        self.vista.tabla_inventario.blockSignals(True)
        self.vista.tabla_inventario.setRowCount(0)
        
        # Forzar solo lectura (bloqueo de doble clic)
        self.vista.tabla_inventario.setEditTriggers(QAbstractItemView.NoEditTriggers)
        ...
        for r_idx, r_data in enumerate(datos):
            ...
            # Rellenar columnas de datos (0 a 8)
